...
In the code above, sum calls itself once; it uses a condition of n == 1 to stop recursing; and, n + sum(n - 1) uses the return value
of the recursive call to compute a new return value.

Write a recursive method that computes the nth Fibonacci number, where nth is an argument to the method.

----

input: an integer (denoting the count of the Fibonacci number we are seeking)
...
define fibonacci method that accepts 1 parameter, n
  ...
  - invoke the fibonacci method and pass in (n-1) and invoke it again and pass in (n-2)
    -> add the two return values and implicitly return the result
